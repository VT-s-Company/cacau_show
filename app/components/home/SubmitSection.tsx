...
export function SubmitSection() {
  ...
  return (
    <div className="flex flex-col items-center gap-4 mt-6 px-4 w-full max-w-md">
      <button className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-sm uppercase tracking-wider w-full py-4 rounded-xl transition-all duration-200 hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed">
        ENVIAR DESENHO
      </button>
